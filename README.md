Nothing to see here yet as of Febuary 2022, will hold the current state (application layer) for my Kubernetes K3s cluster (replicated from my self-hosted) Gitlab. This GitOps repo will also cover Kubernetes support tools and other self-hosted applications I'm running (includes guides). Cluster is comprised of Raspberry Pis (3 & 4), Jetson Nanos and a bunch of old Thinkpads I've collected over the years. I pysically assembled the cluster when I had a tiny bit of free time during paternity leave in the summer of 2021. Now with 2 little ones, I try to work on this late at night when everyone is asleep.  
