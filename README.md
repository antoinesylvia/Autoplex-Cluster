...
- App Package Management:
  - Helm (https://github.com/helm/helm)
    ...
    - Artifact Hub (https://artifacthub.io/packages/search?kind=0&sort=relevance&page=1)
...
- Secrets (either of the following are feasible but I'm using Sealed-Secrets, here's a comparison provided by OpenAI sources: https://i.ibb.co/hXqzSRd/secrets.png): 
  - 1A. Sealed-Secrets (encrypt/decrypt server-side) (https://github.com/bitnami-labs/sealed-secrets)
  - ~~1B. Mozilla SOPS (encrypt/decrypt client-side) (https://github.com/mozilla/sops)~~
